...
import (
	...
	"github.com/CrestFallenTurtle/go-evil/utility/structure"
	"github.com/CrestFallenTurtle/go-evil/utility/structure/functions"
...
func Write(value string, data_object *json.Json_t) []string {
	...
	data_object.Add_go_import("github.com/CrestFallenTurtle/Go-tools")
	data_object.Add_go_import("github.com/CrestFallenTurtle/notify_handler")
